<%-- 
    Document   : Message
    Created on : Feb 22, 2024, 1:33:57 AM
    Author     : DELL
--%>
...
<section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1 class="text-white font-weight-bold">Message</h1>
            </div>
        </div>
    ...
    <script>
          var ws = new WebSocket("ws://localhost:8080/SWP391_HappyJob_G1_/message/" + userId);
...
<div class="flex-grow-1 pl-3">
    ...
    <div class="text-muted small"><em class="m-2">` + response.receiver.name + `</em></div>
                    ...
                    ws = new WebSocket("ws://localhost:8080/SWP391_HappyJob_G1_/message/" + userId);
                    setupWebSocket();
                    console.log("done");
                    console.log(ws);
